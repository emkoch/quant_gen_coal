...
\input{./qst_pop_dist.tex}
\subsubsection{The expected value of $V_{\text{between}}}
\input{./vbetween.tex}
\section{Dominance}
\subsection{The individual variance}
\input{./dom_indv_var.tex}
\subsection{The population variance}
\input{./dom_pop_var.tex}
\section{Epistasis}
