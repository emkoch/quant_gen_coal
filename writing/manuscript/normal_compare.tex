Deviations of the within-population distribution from normality depend on the
...
For a more concrete example, we consider the differences in the expected fourth
