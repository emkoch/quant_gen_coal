...
loci. An analytical expression for the probability distribution of trait values
does not exist except in certain limits such as when the number of mutations
