...
%% The normal model does not provide an analytic form for the neutral distribution
%% of $Q_{ST}$, but it does provide an efficient way to sample from this
%% distribution.

%% The null distribution we obtain through this informed approach performs better
%% than the null distribution suggested by \citet{Whitlock2009}.
